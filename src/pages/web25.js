    ...
    <div>
      ...
      <div className={styles.web25_container}>
        ...
        <p>
          ...
          ecosystems, specifically but not exclusively in Majdanpek, Pirot, Novi
          Pazar, Pančevo, and Niš.The Web 2.5 Academy has a hybrid concept where
          the first and last lectures will be live and the rest online.
          Participants will have the opportunity to meet the lecturers and learn
          about the program during the introductory lecture.
        </p>
            ...
            >
              <div id='mc_embed_signup_scroll'>
                ...
                <div className='optionalParent'>
                  <div className={`clear foot ${styles.chimp_container}`}>
                    <input
                      type='submit'
